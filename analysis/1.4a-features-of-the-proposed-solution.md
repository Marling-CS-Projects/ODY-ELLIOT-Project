...
<figure><img src="../.gitbook/assets/image (1).png" alt=""><figcaption><p><a href="https://soul-knight.fandom.com/wiki/Enemies">https://soul-knight.fandom.com/wiki/Enemies</a></p></figcaption></figure>
...
{% tab title="Starting Characters" %}
I leaving multiple starting characters out of the game as making them unique will prove difficult and may cause changes to the game in order for all characters to be equal.
{% endtab %}
