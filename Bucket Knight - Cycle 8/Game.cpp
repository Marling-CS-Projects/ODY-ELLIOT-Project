...
void Game::AttackGun()
{
	...
	bullet->CreateBullet(player->GetTransform().position.x + 12, player->GetTransform().position.y + 12, 12, 12, "Assets/Bullet.png", "playerbullet", dir, 3, 1, 200);
...
void Game::AttackMagic()
{
	...
	auto bullet = new Bullet();
	bullet->CreateBullet(player->GetTransform().position.x + 12, player->GetTransform().position.y + 12, 12, 12, "Assets/Magic.png", "playerbullet", dir, 3, 3, 300);
	bullet->entity->addGroup(groupBullets);
